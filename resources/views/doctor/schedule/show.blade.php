            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3 d-flex justify-content-between">
                        ...
                        <a href="{{ route('doctor.schedule.index') }}" class="btn btn-primary text-white">Назад</a>
                        <a href="{{route('doctor.schedule.edit', $schedule->id)}}" class="btn btn-primary" style="text-decoration: none;">Изменить</a>
