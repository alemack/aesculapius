...
<div class="container mt-5">
    <div class="card shadow-sm p-3 mb-5 bg-body rounded" style="max-width: 500px; margin: 0 auto;">
        <h1 class="text-center mb-4">Редактирование специализации</h1>
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('admin.specialization.update', $specialization->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $specialization->name) }}" required autofocus class="form-control">
            </div>
