...
<div class="container mt-5">
    <div class="card shadow-sm p-3 mb-5 bg-body rounded" style="max-width: 500px; margin: 0 auto;">
        <h1 class="text-center mb-4">Редактирование Пациента</h1>
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('admin.patient.update', $patient->id) }}">
            ...
            <div class="mb-3">
                ...
                <div class="card shadow-sm p-3 mb-3 bg-body rounded text-center">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $patient->user->name) }}" required autofocus class="form-control">
                </div>
            </div>
            ...
            <a href="{{ route('admin.patient.index') }}" class="btn btn-secondary">Назад</a>
        </form>
    </div>
</div>
@endsection
